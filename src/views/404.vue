<template>
  ...
  <div class="message">
    ...
    <p class="output">
the page you are looking for is corrupt or has been removed. for more information check the link below.</ü>
      <p class="social">Follow me on  <a href="https://github.com/JoaoVictorGRamos">GitHub</a> and <a href="https://codepen.io/Jo-o-Victor-Ramos">CodePen</a></p>
      <p class="output">Good luck</p></p>
  </div>
</div>
</template>
<style>
